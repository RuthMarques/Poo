...
if __name__ == "__main__":
        ...
        match opcao:
            ...
            case "2":
                try:
                    ...
                    print(f"Curso {curso.nome_curso} foi cadastrado com sucesso.")
                except Exception as e:
                    print(f"Não foi possivel cadastrar curso. {e}.")
                finally:
                    continue
            case "3":
                try:
                    ...
                    curso_incricao = input("Curso desejado: ").strip().title()

                    aluno.inscrever_curso(curso_incricao)
                    limpar()

                    print(f"Aluno {aluno.nome} incrito no curso {curso.nome_curso} com sucesso!")
                    
                except Exception as e:
                    print(f"Não foi possivel matricular aluno no curso. {e}.")
                finally:
                    continue
            case "4":
    ...
    # # cursos 
    # curso01 = Curso("Python Dveloper")
    # curso02 = Curso("IA com Python")
    # curso03 = Curso("Desenvolvedor Java")

    # # incevendo os alunos nos cursos
